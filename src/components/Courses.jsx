...
const dummyData = {
  ...
  experts: [
    { id: 1, name: 'Rohan Gupta', degree: 'B.Tech, IIT Jodhpur', description: 'Rohan Gupta has honed his skills in various exams. Currently he is...' },
    { id: 2, name: 'Mohan Lal', degree: 'B.Tech, IIT Kanpur', description: 'Mohan Lal has honed his skills in various exams. Currently he is...' },
    { id: 3, name: 'Sumit Anuragi', degree: 'B.Tech, IIT Delhi', description: 'Sumit Anuragi has honed his skills in various exams. Currently he is...' },
    { id: 4, name: 'Arpita Panda', degree: 'B.Tech, NIT Jammu', description: 'Arpita Panda has honed his skills in various exams. Currently he is...' },
  ],
  communityInsights: [
    { id: 1, name: 'Rohan Gupta', degree: 'B.Tech, IIT Jodhpur', description: 'Rohan Gupta has honed his skills in various exams. Currently he is...' },
    { id: 2, name: 'Rohan Gupta', degree: 'B.Tech, IIT Jodhpur', description: 'Rohan Gupta has honed his skills in various exams. Currently he is...' },
    { id: 3, name: 'Rohan Gupta', degree: 'B.Tech, IIT Jodhpur', description: 'Rohan Gupta has honed his skills in various exams. Currently he is...' },
  ],
};
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {dummyData.schedules.map((schedule) => (
            <ScheduleButton key={schedule.id} name={schedule.name} duration={schedule.duration} />
          ))}
        </div>
      </section>
